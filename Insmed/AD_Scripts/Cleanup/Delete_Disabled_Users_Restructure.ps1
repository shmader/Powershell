...
#
# Purpose: 
# This script will delete the unused user accounts in the new "Users pending delete" OU using the last logon attributes. 
...
$logfilepath= "C:\temp\AD_Reports\Users_Cleanup\AD_Users_Deletion_Log_Restructure"+$todaysdate+".txt"
$logFile = $logFilePath
...
$users = Get-ADUser -Filter * -SearchBase "OU=Users Pending Delete,OU=Disabled Users,OU=Insmed Users,DC=insmed,DC=local" -SearchScope Subtree -Properties *
