...
New-ADUser -Path 'OU=FVTPL_Accounts,DC=fortville,DC=lib,DC=in,DC=us' -SamAccountName $sam -name $sam -UserPrincipalName $upn -GivenName $first -Surname $last -DisplayName $display -Title $title -Department $dept -EmailAddress $upn 
